...
class Proyectofinal {
	...
	case 1:
		...
		JOptionPane.showMessageDialog(null,"","Bienvenida",JOptionPane.DEFAULT_OPTION,new ImageIcon(Proyectofinal.class.getResource("/img/titulo.jpg")));
			...
			JOptionPane.showMessageDialog(null, " Su dado es "+dj1 , "Tres o más", JOptionPane.DEFAULT_OPTION, new ImageIcon(Proyectofinal.class.getResource("/img/dado"+dj1+".png")));
	    	JOptionPane.showMessageDialog(null, " Su dado es "+dj2 , "Tres o más", JOptionPane.DEFAULT_OPTION, new ImageIcon(Proyectofinal.class.getResource("/img/dado"+dj2+".png")));
	    	JOptionPane.showMessageDialog(null, " Su dado es "+dj3 , "Tres o más", JOptionPane.DEFAULT_OPTION, new ImageIcon(Proyectofinal.class.getResource("/img/dado"+dj3+".png")));
	    	JOptionPane.showMessageDialog(null, " Su dado es "+dj4 , "Tres o más", JOptionPane.DEFAULT_OPTION, new ImageIcon(Proyectofinal.class.getResource("/img/dado"+dj4+".png")));
	    	JOptionPane.showMessageDialog(null, " Su dado es "+dj5 , "Tres o más", JOptionPane.DEFAULT_OPTION, new ImageIcon(Proyectofinal.class.getResource("/img/dado"+dj5+".png")));
			...
			case 2://Modalidad 2 jugadores
				do {
					...
					JOptionPane.showMessageDialog(null, " Su dado es "+dpc1 , "Tres o más", JOptionPane.DEFAULT_OPTION, new ImageIcon(Proyectofinal.class.getResource("/img/dado"+dpc1+".png")));
			    	JOptionPane.showMessageDialog(null, " Su dado es "+dpc2 , "Tres o más", JOptionPane.DEFAULT_OPTION, new ImageIcon(Proyectofinal.class.getResource("/img/dado"+dpc2+".png")));
			    	JOptionPane.showMessageDialog(null, " Su dado es "+dpc3 , "Tres o más", JOptionPane.DEFAULT_OPTION, new ImageIcon(Proyectofinal.class.getResource("/img/dado"+dpc3+".png")));
			    	JOptionPane.showMessageDialog(null, " Su dado es "+dpc4 , "Tres o más", JOptionPane.DEFAULT_OPTION, new ImageIcon(Proyectofinal.class.getResource("/img/dado"+dpc4+".png")));
			    	JOptionPane.showMessageDialog(null, " Su dado es "+dpc5 , "Tres o más", JOptionPane.DEFAULT_OPTION, new ImageIcon(Proyectofinal.class.getResource("/img/dado"+dpc5+".png")));
			    	if (dpc1==dpc2 && dpc2==dpc3 && dpc3==dpc4 && dpc4==dpc5 && dpc5==dpc1) {
					...
					switch (contp1) {
					case 4:
						JOptionPane.showMessageDialog(null, "********** Tabla de resultados **********\n"+nombrej1+ "\nRonda n°1: "+puntuacionj1[0]+ "\nRonda n°2: "+puntuacionj1[1]+"\nRonda n°3: "+puntuacionj1[2]+ "\nRonda n°4: "+puntuacionj1[3]+ "\nRonda n°5: "+puntuacionj1[4]+"\nPuntuación total: "+totj11,"Tres o mas",JOptionPane.DEFAULT_OPTION,new ImageIcon(Proyectofinal.class.getResource("/img/j1puntuaciontotal.jpg")));	
						JOptionPane.showMessageDialog(null, "********** Tabla de resultados **********\n"+nombrej2+ "\nRonda n°1: "+puntuacionj2[0]+ "\nRonda n°2: "+puntuacionj2[1]+"\nRonda n°3: "+puntuacionj2[2]+ "\nRonda n°4: "+puntuacionj2[3]+ "\nRonda n°5: "+puntuacionj2[4]+"\nPuntuación total: "+totj2,"Tres o mas",JOptionPane.DEFAULT_OPTION,new ImageIcon(Proyectofinal.class.getResource("/img/j2puntuaciontotal.jpg")));			
						break;
	...
	JOptionPane.showMessageDialog(null, "Adivina el Número es un juego en que tienes que utilizar tu lógica\npara adivinar un número secreto de 5 dígitos que el ordenador escoge\nal principio del partido. El número está formado por dígitos del 0 al 9\ncada dígito aparece una vez como máximo.","Adivina el numero",JOptionPane.DEFAULT_OPTION,new ImageIcon(Proyectofinal.class.getResource("/img/tituloadivina.jpg")));
	do {
  ...
  //controla la repetición de los digitos
    for (int i = 0; i <=4; i++) {
